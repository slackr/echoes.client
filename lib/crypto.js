 ...
 *
 * Export keychain values: ['keyx_public','encrypt_public','sign_public','sign_private']
 *
 ...
 *
 * For hkdf method, private_key is the HKDF basekey after import
 *
...
EchoesCrypto.prototype.decrypt_asym = function(data_segments, private_key, leftovers) {
    ...
    return crypto.subtle.decrypt(this.algo.encrypt, private_key, this.string_to_ab(leftovers[0]))
        .then(function(k) {
            leftovers.shift();
